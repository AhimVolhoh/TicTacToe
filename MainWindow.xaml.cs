...
namespace TicTacToe
{
	...
	public partial class MainWindow : Window
	{
		...
		/// <summary>
		/// Starts a new game and clear all values back to the start
		/// </summary>
		private void NewGame()
		{
			//Create a new blank arrey of free cells
			...
			//Makw sure the game hasn't finished
			mGameEnded = false;
		}
		...
		private void Button_Click(object sender, RoutedEventArgs e)
		{
			...
			//Cast the sender to a buttom
			var button = (Button)sender;

			//Find the buttons position in the arrey
		...
		/// <summary>
		/// Check if there is a winner of a 3 lines straight
		/// </summary>
